...
namespace StockExchange.Infrastructure.Migrations
{
    ...
    public partial class AddIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Stock",
                columns: new[] { "Id", "CurrentPrice", "CurrentPriceDateTime", "FullName", "ImageSrcUrl", "TickerSymbol" },
                values: new object[,]
                {
                    { 1, 150.00m, new DateTime(2025, 11, 2, 22, 58, 40, 101, DateTimeKind.Utc).AddTicks(3199), "Apple Inc.", "/img/stocks/AAPL.png", "AAPL" },
                    { 2, 400.00m, new DateTime(2025, 11, 2, 22, 58, 40, 101, DateTimeKind.Utc).AddTicks(3880), "Microsoft Corporation", "/img/stocks/MSFT.png", "MSFT" },
                    { 3, 280.00m, new DateTime(2025, 11, 2, 22, 58, 40, 101, DateTimeKind.Utc).AddTicks(3902), "Alphabet Inc.", "/img/stocks/GOOGL.png", "GOOGL" },
                    { 4, 250.00m, new DateTime(2025, 11, 2, 22, 58, 40, 101, DateTimeKind.Utc).AddTicks(3905), "Amazon.com, Inc.", "/img/stocks/AMZN.png", "AMZN" },
                    { 5, 450.00m, new DateTime(2025, 11, 2, 22, 58, 40, 101, DateTimeKind.Utc).AddTicks(3909), "Tesla, Inc.", "/img/stocks/TSLA.png", "TSLA" }
                });
